<div class="table-responsive">
    ...
    <div class="row" style="margin-bottom:20px;">
        <div class="col-md-12 text-center">
            <h5>
                LAPORAN STATUS PENYELESIAN REKOMENDASI - TAHUN<br>
                ...
                BIDANG <span style="font-weight: bold;text-decoration:underline" id="span_unitkerja">{{isset($nbidang) ? $nbidang->nama_bidang : 'BIDANG'}}</span><br>
                UNIT KERJA <span style="font-weight: bold;text-decoration:underline" id="span_unitkerja">{{isset($dunitkerja) ? $dunitkerja->nama_pic : 'UNITKERJA2'}}</span><br>
            </h5>
        </div>
    </div>
    <hr>
