...
@section('title')
    <title>Laporan Status Penyelesaian Rekomendasi - LHP</title>
@endsection
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">Laporan Status Penyelesaian Rekomendasi - LHP</span>
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            ...
            $.ajax({
                url : flagsUrl+'/laporan/status-penyelesaian-rekomendasi-data',
                data : {unit_kerja1:unit_kerja1,bidang:bidang,pemeriksa: pemeriksa, no_lhp:no_lhp, tgl_awal: tanggal_awal, tgl_akhir: tanggal_akhir, overdue:overdue, level_resiko:level_resiko},
                type : 'POST',
