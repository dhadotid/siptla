...
@section('title')
    <title>Laporan Rekap Status Rekomendasi Per Unit Kerja</title>
@endsection
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">Laporan Rekap Status Rekomendasi Per Unit Kerja</span>
							...
							<div class="panel-body">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group" style="margin-bottom:5px;">
                                        ...
                                        <div class="col-md-6">
                                            <select class="select2 form-control" name="unit-kerja" id="unit-kerja"></select>
                                        </div>
                                    </div>
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            $('#data').load(flagsUrl+'/laporan/rekap-status-rekomendasi-unitkerja-data',function(){
                $('#table').DataTable();
            });
        }
	</script>
