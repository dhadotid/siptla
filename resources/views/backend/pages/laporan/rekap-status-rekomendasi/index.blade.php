...
@section('title')
    <title>Laporan Rekap Status Rekomendasi Semua Pemeriksa</title>
@endsection
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">Laporan Rekap Status Rekomendasi Semua Pemeriksa</span>
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            $('#data').load(flagsUrl+'/laporan/rekap-status-rekomendasi-data',function(){
                $('#table').DataTable();
            });
        }
	</script>
