<div class="panel-group accordion" id="accordion" role="tablist" aria-multiselectable="true"  style="border:1px solid #eee;">
	<div class="panel panel-info">
		<div class="panel-heading" role="tab" id="heading-rekom">
			<a class="accordion-toggle" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-rekomendasi" aria-expanded="true" aria-controls="collapse-rekomendasi">
				<h4 class="panel-title">Rangkuman Rekomendasi</h4>
				<i class="fa acc-switch"></i>
			</a>
        </div>
		<div id="collapse-rekomendasi" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading-rekom" aria-expanded="true">
...
<div class="panel-group accordion" id="accordion" role="tablist" aria-multiselectable="true"  style="border:1px solid #eee;">
	<div class="panel panel-info">
		<div class="panel-heading" role="tab" id="heading-tl">
			<a class="accordion-toggle collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-tindaklanjut" aria-expanded="false" aria-controls="collapse-tindaklanjut">
				<h4 class="panel-title">Form Rangkuman Tindak Lanjut</h4>
				<i class="fa acc-switch"></i>
			</a>
        </div>
        <input type="hidden" name="idrekomendasi" value="{{$rekom->id}}" id="idrekomendasi">
		<div id="collapse-tindaklanjut" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-tl" aria-expanded="false" style="height: 0px;">
			<div class="panel-body">
