<div class="row">
    <div class="col-md-12" style="margin-top:10px;">
        ...
        <div class="form-group" style="margin-bottom:10px;">
            <label for="exampleTextInput1" class="col-sm-3 control-label text-right">No Rekening:
            </label>
            <div class="col-sm-9">
                <input type="text" class="form-control "  class="form-control"  name="no_rekening"  placeholder="No. Rekening" id="no_rekening">
            </div>
        </div>  
        <div class="form-group" style="margin-bottom:10px;">
        ...
        <div class="form-group" style="margin-bottom:10px;">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control nominal"  class="form-control"  name="jenis_akhir"  placeholder="Saldo Akhir" id="jenis_akhir">
            </div>
        </div>  
