<div class="table-responsive">
    <div class="row" style="margin-bottom:20px;">
        ...
        <div class="col-md-1 text-right">
            <form action="{{url('laporan/status-penyelesaian-rekomendasi-bidang-pdf')}}" method="post" id="cetakpdf" target="_blank">
                @csrf
        ...
        <div class="col-md-1 text-right">
            <form action="{{url('laporan/status-penyelesaian-rekomendasi-bidang-pdf')}}" method="post" id="cetakxls" target="_blank">
                @csrf
                <input type="hidden" name="pemeriksa" value="{{implode(',', $request->pemeriksa)}}">
                <input type="hidden" name="unit_kerja1" value="{{implode(',', $request->unit_kerja1)}}">
                <input type="hidden" name="no_lhp" value="{{implode(',', $no_lhp)}}">
