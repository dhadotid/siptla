...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            ...
            $.ajax({
                url : flagsUrl+'/laporan/tindaklanjut-per-bidang-data',
                data : {bidang:bidang,pemeriksa: pemeriksa, no_lhp:no_lhp, tgl_awal: tanggal_awal, tgl_akhir: tanggal_akhir, statusrekomendasi: statusrekomendasi, pejabat:pejabat},
                type : 'POST',
