...
@section('title')
    <title>{{strtoupper('Laporan Rekomendasi Overdue - Unit Kerja')}}</title>
@endsection
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">{{strtoupper('Laporan Rekomendasi Overdue - Unit Kerja')}}</span>
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            ...
            $.ajax({
                url : flagsUrl+'/laporan/rekomendasi-overdue-unitkerja-data',
