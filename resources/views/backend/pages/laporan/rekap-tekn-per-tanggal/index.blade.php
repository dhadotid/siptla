...
@section('title')
    <title>Laporan Rekap Perhitungan TEKN Per Tanggal</title>
@endsection
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">Laporan Rekap Perhitungan TEKN Per Tanggal</span>
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            $('#data').load(flagsUrl+'/laporan/rekap-perhitungan-tekn-pertanggal-data',function(){
                $('#table').DataTable();
            });
        }
	</script>
