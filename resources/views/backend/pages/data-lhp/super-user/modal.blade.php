    ...
    <div class="modal fade" id="modaldetailrekomendasi"  role="dialog">
		<div class="modal-dialog" style="width:60% !important">
			<div class="modal-content">
                    ...
                    <div class="modal-body">
                        @include('backend.pages.data-lhp.auditor-senior.rekomendasi-detail',$dt)
                    </div>
                    <div class="modal-footer">
                ...
                <form action="{{ url('data-temuan-lhp-simpan/'.$idlhp) }}" method="POST" class="form-horizontal" id="formadd">
                    ...
                    <div class="modal-body">
                        @php
                            $dt['act']='add';
                        @endphp
                        @include('backend.pages.data-lhp.auditor-senior.temuan-form',$dt)
                    </div>
                    <div class="modal-footer">
                        <button type="button" data-dismiss="modal" class="btn btn-default">Batal</button>
    ...
    <div class="modal fade" id="modaldetail"  role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
                    ...
                    <div class="modal-body">
                        @include('backend.pages.data-lhp.auditor-senior.temuan-detail')
                    </div>
                    <div class="modal-footer">
                        <button type="button" data-dismiss="modal" class="btn btn-primary">Tutup</button>
                    </div>
		...
		<div class="modal-dialog modal-lg" style="width:90%;">
			<div class="modal-content">
                <form action="#" method="POST" class="form-horizontal" id="form-update-rincian">
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="modaltitle">Update Rincian Tindak Lanjut</h4>
                    </div>
                    <div class="modal-body">
