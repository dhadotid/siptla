...
@section('title')
    <title>Laporan Rekap Resiko Per Bidang</title>
@endsection
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">Laporan Rekap Resiko Per Bidang</span>
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            $('#data').load(flagsUrl+'/laporan/rekap-jumlah-resiko-bidang-data',function(){
                $('#table').DataTable();
            });
        }
	</script>
