...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            ...
            $.ajax({
                url : '{{url("/")}}/data-tindaklanjut-seniorlist',
        ...
        {
            location.href=flagsUrl+'/data-tindaklanjut-senior/'+tahun;
        }
...
@section('modal')
    ...
    @include('backend.pages.data-lhp.auditor-senior.modal-tindaklanjut')
@endsection