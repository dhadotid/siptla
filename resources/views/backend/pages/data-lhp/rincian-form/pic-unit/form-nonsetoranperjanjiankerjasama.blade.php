<div class="row">
    <div class="col-md-12" style="margin-top:10px;">
        ...
        <div class="form-group" style="margin-bottom:10px;">
            <label for="exampleTextInput1" class="col-sm-3 control-label text-right">No. PKS:</small>
            </label>
            <div class="col-sm-7">
                <textarea class="form-control"  name="no_pks" placeholder="No. PKS" id="no_pks"></textarea>
            </div>
        </div> 
        <div class="form-group" style="margin-bottom:10px;">
           <label for="exampleTextInput1" class="col-sm-3 control-label text-right">Tanggal PKS:</small>
            ...
            <div class="col-md-7">
                <div class='input-group date' id='datetimepicker_tgl_pks'>
                    <input type='date' class="form-control" name="tanggal_pks" id="tanggal_pks"  value="{{date('d/m/Y')}}"/>
                    <span class="input-group-addon bg-info text-white">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                </div>
        ...
        <div class="form-group" style="margin-bottom:10px;">
            <label for="exampleTextInput1" class="col-sm-3 control-label text-right">Periode Perpanjangan PKS:</small>
            </label>
            <div class="col-sm-7">
                <textarea class="form-control"  name="periode_perpanjangan_pks" placeholder="Periode Perpanjangan PKS" id="periode_perpanjangan_pks"></textarea>
            </div>
        </div> 
