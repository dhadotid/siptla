<h3 class="text-center">Rincian Nilai – Rekomendasi Non Setoran</h3><table class="table table-bordered"  id="table-rincian-nonsetoran">
            ...
            @if (Auth::user()->level != 'pic-unit')
                    <tr >
                        <td class="text-center" colspan="8"><a href="#" onclick="addtindaklanjut('nonsetoran','{{$idtemuan}}','{{$idrekomendasi}}',-1)" class="label label-info" id="tombol-add-rincian" style="display:inline"><i class="fa fa-plus-circle"></i> Tambah Rincian</a></td>
                    </tr>
            @endif
