...
@section('title')
    <title>LAPORAN STATUS PENYELESIAN REKOMENDASI UNIT KERJA</title>
@endsection
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">LAPORAN STATUS PENYELESIAN REKOMENDASI UNIT KERJA</span>
							...
							<div class="panel-body">
                                 <div class="form-horizontal">
                                    ...
                                    <select class="select2 form-control" name="unit_kerja1[]" id="unit_kerja1" multiple>
                                            ...
                                            <select class="select2 form-control" name="unit_kerja2[]" id="unit_kerja2" multiple>
                                                <option value="{{$unitkerja->id}}" selected>Semua</option>
                                            </select>
                                    </span>
                                    @endif
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            ...
            $.ajax({
                url : flagsUrl+'/laporan/status-penyelesaian-rekomendasi-unitkerja-data',
                data : {unit_kerja1:unit_kerja1,bidang:bidang,pemeriksa: pemeriksa, no_lhp:no_lhp, tgl_awal: tanggal_awal, tgl_akhir: tanggal_akhir, level_resiko:level_resiko},
                type : 'POST',
