...
@section('title')
    <title>Laporan Rekap Perhitungan TEKN Per Status</title>
@endsection
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">Laporan Rekap Perhitungan TEKN Per Status</span>
							...
							<div class="panel-body">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group" style="margin-bottom:5px;">
                                        ...
                                        <div class="col-md-6">
                                            <select class="select2 form-control" name="status" id="status"></select>
                                        </div>
                                    </div>
									<div class="form-group" style="margin-bottom:5px;">
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            $('#data').load(flagsUrl+'/laporan/rekap-perhitungan-tekn-status-data',function(){
                $('#table').DataTable();
            });
        }
	</script>
