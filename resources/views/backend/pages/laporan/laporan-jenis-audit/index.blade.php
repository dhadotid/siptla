						...
						<div id="collapse-1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-1" aria-expanded="false" style="height: 0px;">
							<div class="panel-body">
                                 <div class="form-horizontal">
                                    ...
                                    <div class="form-group" style="margin-bottom:5px;">
                                        <label for="my-input" class="col-md-3">Jenis Audit</label>
                                        <div class="col-md-6">
                                            <select class="select2 form-control" name="jenis-audit[]" id="jenis-audit" onchange="loaddata()" multiple>
                                                    <option value="0" selected>Semua</option>
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            ...
            var jenis_audit=$('#jenis-audit').val();
            ...
            $.ajax({
                url : flagsUrl+'/laporan/laporan-jenis-audit-data',
                data : {pemeriksa:pemeriksa,jenis_audit: jenis_audit, no_lhp:no_lhp, tgl_awal: tanggal_awal, tgl_akhir: tanggal_akhir, kode_lhp:kode_lhp},
                type : 'POST',
