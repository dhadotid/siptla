...
@section('title')
    <title>Laporan Temuan Per Unit Kerja </title>
@endsection
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">Laporan Temuan Per Unit Kerja </span>
							...
							<div class="panel-body">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group" style="margin-bottom:5px;">
                                        ...
                                        <div class="col-md-6">
                                            <select class="select2 form-control" name="level-resiko" id="level-resiko"></select>
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-bottom:5px;">
                                        <label for="my-input" class="col-md-3">PIC Unit Kerja 1</label>
                                        <div class="col-md-6">
                                            <select class="select2 form-control" name="pic-unit-1" id="pic-unit-1"></select>
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-bottom:5px;">
                                        <label for="my-input" class="col-md-3">PIC Unit Kerja 2</label>
                                        <div class="col-md-6">
                                            <select class="select2 form-control" name="pic-unit-2" id="pic-unit-2"></select>
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-bottom:5px;">
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            $('#data').load(flagsUrl+'/laporan/temuan-per-bidang-data',function(){
                $('#table').DataTable();
            });
        }
	</script>
