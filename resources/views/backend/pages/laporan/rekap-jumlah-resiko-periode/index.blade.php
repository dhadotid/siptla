...
@section('title')
    <title>Laporan Rekap Jumlah Resiko Per Periode</title>
@endsection
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">Laporan Rekap Jumlah Resiko Per Periode</span>
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            $('#data').load(flagsUrl+'/laporan/rekap-jumlah-resiko-periode-data',function(){
                $('#table').DataTable();
            });
        }
	</script>
