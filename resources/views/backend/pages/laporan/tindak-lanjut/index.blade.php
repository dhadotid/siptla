	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<span class="widget-title">Laporan Tindak Lanjut </span>
							...
							<div class="panel-body">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group" style="margin-bottom:5px;">
                                        ...
                                        <div class="col-md-6">
                                            <select class="select2 form-control" name="unit_kerja" id="unit_kerja"></select>
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-bottom:5px;">
...
@section('footscript')
	...
	<script>
        ...
        function loaddata()
        {
            $('#data').load(flagsUrl+'/laporan/tindak-lanjut-data',function(){
                $('#table').DataTable();
            });
        }
	</script>
