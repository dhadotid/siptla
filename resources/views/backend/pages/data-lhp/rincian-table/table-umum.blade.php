<h3 class="text-center">Rincian Nilai – Rekomendasi Umum (Setoran)</h3><table class="table table-bordered"  id="table-rincian-umum">
            <thead>
                <tr class="inverse">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        @if (Auth::user()->level == 'pic-unit')
                            <a href="javascript:addtindaklanjutrincian({{$v->id}},'umum',{{$v->jumlah_rekomendasi}},'{{Config::get('constants.rincian.umum')}}')" class="btn-delete btn btn-xs btn-info"><i  class="glyphicon glyphicon-plus"></i></a>&nbsp;
                        @else
                            <div class="btn-group">
                        ...
                        @endif
                        <a href="javascript:listtindaklanjutrincian({{$v->id}},'umum',{{$v->jumlah_rekomendasi}})" class="btn-edit btn btn-xs btn-success" style="height:28px;"><i class="glyphicon glyphicon-list"></i></a>
                    </td>
                </tr>
                @php
                    $no++;
